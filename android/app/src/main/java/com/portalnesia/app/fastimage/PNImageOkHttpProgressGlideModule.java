...
@GlideModule
public class PNImageOkHttpProgressGlideModule extends LibraryGlideModule {
    ...
    static void expect(String key, PNImageProgressListener listener) {
        progressListener.expect(key, listener);
    }

    private interface ResponseProgressListener {
        void update(String key,long bytesRead,long expectedLength);
    }

    private static class DispatchingProgressListener implements ResponseProgressListener {
        private final Map<String, PNImageProgressListener> LISTENERS = new WeakHashMap<>();
        ...
        void expect(String key, PNImageProgressListener listener) {
            LISTENERS.put(key, listener);
        }

        @Override
        public void update(final String key, final long bytesRead, final long contentLength) {
            final PNImageProgressListener listener = LISTENERS.get(key);
            if (listener == null) {
                return;
            }
