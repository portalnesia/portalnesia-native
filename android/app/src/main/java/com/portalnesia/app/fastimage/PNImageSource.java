...
public class PNImageSource extends ImageSource {
    ...
    public PNImageSource(Context context, String source) {
        this(context, source, null);
    }

    public PNImageSource(Context context, String source, @Nullable Headers headers) {
        this(context, source, 0.0d, 0.0d, headers);
    }

    public PNImageSource(Context context, String source, double width, double height, @Nullable Headers headers) {
    ...
    public boolean isBase64Resource() {
        return mUri != null && PNImageSource.isBase64Uri(mUri);
    }

    public boolean isResource() {
        return mUri != null && PNImageSource.isResourceUri(mUri);
    }

    public boolean isLocalFile() {
        return mUri != null && PNImageSource.isLocalFileUri(mUri);
    }

    public boolean isContentUri() {
        return mUri != null && PNImageSource.isContentUri(mUri);
    }
